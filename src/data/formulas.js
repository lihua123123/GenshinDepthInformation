...
$$
抗性系数 = \\left|\\begin{aligned}& 1 - \\frac{抗性}{2} & 抗性 \\leqslant 0 \\\\
...
> （来自角色的**减防**不能超过 $90\\%$，**无视防御**不能超过 $100\\%$）
...
> <font color="#4ade80">草原核</font>伤害**不算<font color="#4ade80">月绽放</font>**，<font color="#4ade80">月绽放</font>伤害**只包括直伤**
> <font color="#4ade80">草原核</font>伤害仍为**<font color="#4ade80">绽放/烈绽放/超绽放</font>伤害**
...
**直伤<font color="#7950f2">月感电</font>**：直伤系数为：$0.3$，属性值为：$攻击力$
**直伤<font color="#4ade80">月绽放</font>**：直伤系数为：$1.2$，属性值为：$元素精通$
**直伤<font color="#eab308">月结晶</font>**：直伤系数为：$0.5$，属性值为：$防御力$

> 对于哥伦比娅来说，上述属性值均为：$生命值$
...
> 极星辉域会每 **4s** 记录领域内的<font color="#7950f2">雷</font>/<font color="#22d3ee">冰</font>元素附着次数之和，记录上限为12次，持续 **4s**，重复触发时刷新持续时间
...
> **星超导系数**会根据极星辉域记录的<font color="#7950f2">雷</font>/<font color="#22d3ee">冰</font>元素附着次数之和决定
> **星扩散系数**为：$0.75$
...
---`
  ...
  {
    "title": "激化反应",
    "content": `当**<font color="#7950f2">雷元素</font>**触及**<font color="#4ade80">草元素</font>**时，会按照 $1:1:1$ 的比例互相消耗并生成**原激化元素**
...
---`
  ...
  {
    "title": "剧变反应",
    "content": `剧变反应包括：<font color="#ee0000">超载</font>、<font color="#22d3ee">超导</font>、<font color="#7950f2">感电</font>、<font color="#ee0000">燃烧</font>、碎冰、<font color="#34d399">扩散</font>、<font color="#4ade80">绽放</font>、<font color="#4ade80">超绽放</font>、<font color="#4ade80">烈绽放</font>
...
---`
  ...
  {
    "title": "结晶反应",
    "content": `触发**<font color="#eab308">结晶</font>**反应时，会掉落对应<font color="#ee0000">火</font>/<font color="#0066cc">水</font>/<font color="#7950f2">雷</font>/<font color="#22d3ee">冰</font>元素的晶片，拾取后可获得护盾
